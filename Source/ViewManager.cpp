...
namespace
{
	...
	// movement speed multiplier that can be adjust with mouse scroll
...
void ViewManager::Mouse_Position_Callback(GLFWwindow* window, double xMousePos, double yMousePos)
{
	...
	g_pCamera->ProcessMouseMovement(xOffset * 20.0f, yOffset * 20.0f); // made this bigger that assignment 4 since this speed felt better as a user. 
}
...
static void Mouse_Scroll_Callback(GLFWwindow* window, double xOffset, double yOffset)
{
	...
	gCameraSpeed += (float)yOffset * 0.1f;
	
	// clamp the speed to reasonable values to prevent negative or excessively high speeds
	if (gCameraSpeed < 0.1f)
		gCameraSpeed = 0.1f;
	if (gCameraSpeed > 5.0f)
		gCameraSpeed = 5.0f;
}
